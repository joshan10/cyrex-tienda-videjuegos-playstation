...
/**
 * Componente reutilizable WhatsAppButton
 * Botón flotante fijo para contactar soporte vía WhatsApp.
 */
export default function WhatsAppButton({
  phoneNumber = '573001234567',
  message = '¡Hola! Me interesa un videojuego de Cyrex PlayStation Premium.',
}) {
